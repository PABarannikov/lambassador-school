...
function initLanguageSwitcher() {
    ...
    const translations = {
        en: {
            ...
            'hero-tagline-bottom': '<span class="nowrap">Elevating Service.</span> <span class="nowrap">Inspiring Excellence.</span>',
            ...
            'offer-3-title': 'Talent Tailoring',
        ...
        pt: {
            ...
            'hero-tagline-bottom': '<span class="nowrap">Elevando o Serviço.</span> <span class="nowrap">Inspirando Excelência.</span>',
            ...
            'offer-3-title': 'Personalização de Talentos',
