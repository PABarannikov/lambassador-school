...
function initLanguageSwitcher() {
    ...
    const translations = {
        en: {
            ...
            'whatwedo-benefit-1': 'Our training programs are designed for both newcomers and experienced sales assistants, as well as for those who want to start a career as a SA.',
            ...
            'whatwedo-benefit-3': 'This is not a lecture-based course. Our training is dynamic, highly interactive, and filled with practical activities that keep participants engaged and involved throughout the program.',
            ...
            'founder-text-3': 'Holding a university degree in Education and a CELTA certification, she brings a strong pedagogical foundation in adult learning methodologies, facilitation, and training design. Her professional development also includes two specialized training programs within the LVMH Group, as well as studies with the CIPD (Chartered Institute of Personnel and Development) in People Management.',
